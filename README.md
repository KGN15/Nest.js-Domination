...
## Whare To Larn
Theare's is the full documentation in the main website of Nest.js in (https://docs.nestjs.com/providers)

so you can larn from thearea and manny youtube tutorial is pleced for larning nest.js but my case i have ben larning with flow with the official documentation and geting help of *AI*

You can copy my this code base and se nots, practises, projects.
